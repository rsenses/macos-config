---
description: Refine codebase architecture
---
...
Use loaded project memory to avoid repeated mistakes and follow durable project preferences, but do not let memory broaden the refinement scope. At the end of meaningful refinements, append a concise daily note with what changed and any validation status.
