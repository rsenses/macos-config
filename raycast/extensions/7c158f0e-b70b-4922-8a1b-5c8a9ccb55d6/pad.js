"use strict";var Te=Object.create;var U=Object.defineProperty;var Ee=Object.getOwnPropertyDescriptor;var Re=Object.getOwnPropertyNames;var Fe=Object.getPrototypeOf,Ce=Object.prototype.hasOwnProperty;var Q=(r,e)=>(e=Symbol[r])?e:Symbol.for("Symbol."+r),Y=r=>{throw TypeError(r)};var De=(r,e)=>{for(var t in e)U(r,t,{get:e[t],enumerable:!0})},ee=(r,e,t,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Re(e))!Ce.call(r,s)&&s!==t&&U(r,s,{get:()=>e[s],enumerable:!(a=Ee(e,s))||a.enumerable});return r};var x=(r,e,t)=>(t=r!=null?Te(Fe(r)):{},ee(e||!r||!r.__esModule?U(t,"default",{value:r,enumerable:!0}):t,r)),Ue=r=>ee(U({},"__esModule",{value:!0}),r);var O=(r,e,t)=>{if(e!=null){typeof e!="object"&&typeof e!="function"&&Y("Object expected");var a,s;t&&(a=e[Q("asyncDispose")]),a===void 0&&(a=e[Q("dispose")],t&&(s=a)),typeof a!="function"&&Y("Object not disposable"),s&&(a=function(){try{s.call(this)}catch(i){return Promise.reject(i)}}),r.push([t,a,e])}else t&&r.push([t]);return e},_=(r,e,t)=>{var a=typeof SuppressedError=="function"?SuppressedError:function(n,c,u,l){return l=Error(u),l.name="SuppressedError",l.error=n,l.suppressed=c,l},s=n=>e=t?new a(n,e,"An error was suppressed during disposal"):(t=!0,n),i=n=>{for(;n=r.pop();)try{var c=n[1]&&n[1].call(n[2]);if(n[0])return Promise.resolve(c).then(i,u=>(s(u),i()))}catch(u){s(u)}if(t)throw e};return i()};var Ze={};De(Ze,{default:()=>Pe});module.exports=Ue(Ze);var k=require("@raycast/api");var X=require("child_process");var w=require("child_process"),p=x(require("fs")),y=x(require("os")),d=x(require("path")),o=require("@raycast/api");var v=x(require("react")),h=require("@raycast/api");var ne=x(require("node:child_process")),se=require("node:buffer"),F=x(require("node:stream")),ie=require("node:util");var oe=require("react/jsx-runtime");var M=globalThis;var N=r=>!!r&&typeof r=="object"&&typeof r.removeListener=="function"&&typeof r.emit=="function"&&typeof r.reallyExit=="function"&&typeof r.listeners=="function"&&typeof r.kill=="function"&&typeof r.pid=="number"&&typeof r.on=="function",j=Symbol.for("signal-exit emitter"),z=class{constructor(){if(this.emitted={afterExit:!1,exit:!1},this.listeners={afterExit:[],exit:[]},this.count=0,this.id=Math.random(),M[j])return M[j];Object.defineProperty(M,j,{value:this,writable:!1,enumerable:!1,configurable:!1})}on(e,t){this.listeners[e].push(t)}removeListener(e,t){let a=this.listeners[e],s=a.indexOf(t);s!==-1&&(s===0&&a.length===1?a.length=0:a.splice(s,1))}emit(e,t,a){if(this.emitted[e])return!1;this.emitted[e]=!0;let s=!1;for(let i of this.listeners[e])s=i(t,a)===!0||s;return e==="exit"&&(s=this.emit("afterExit",t,a)||s),s}},B=class{onExit(){return()=>{}}load(){}unload(){}},H=class{#o;#t;#e;#s;#i;#n;#a;#r;constructor(e){this.#o=process.platform==="win32"?"SIGINT":"SIGHUP",this.#t=new z,this.#n={},this.#a=!1,this.#r=[],this.#r.push("SIGHUP","SIGINT","SIGTERM"),globalThis.process.platform!=="win32"&&this.#r.push("SIGALRM","SIGABRT","SIGVTALRM","SIGXCPU","SIGXFSZ","SIGUSR2","SIGTRAP","SIGSYS","SIGQUIT","SIGIOT"),globalThis.process.platform==="linux"&&this.#r.push("SIGIO","SIGPOLL","SIGPWR","SIGSTKFLT"),this.#e=e,this.#n={};for(let t of this.#r)this.#n[t]=()=>{let a=this.#e.listeners(t),{count:s}=this.#t,i=e;if(typeof i.__signal_exit_emitter__=="object"&&typeof i.__signal_exit_emitter__.count=="number"&&(s+=i.__signal_exit_emitter__.count),a.length===s){this.unload();let n=this.#t.emit("exit",null,t),c=t==="SIGHUP"?this.#o:t;n||e.kill(e.pid,c)}};this.#i=e.reallyExit,this.#s=e.emit}onExit(e,t){if(!N(this.#e))return()=>{};this.#a===!1&&this.load();let a=t?.alwaysLast?"afterExit":"exit";return this.#t.on(a,e),()=>{this.#t.removeListener(a,e),this.#t.listeners.exit.length===0&&this.#t.listeners.afterExit.length===0&&this.unload()}}load(){if(!this.#a){this.#a=!0,this.#t.count+=1;for(let e of this.#r)try{let t=this.#n[e];t&&this.#e.on(e,t)}catch{}this.#e.emit=(e,...t)=>this.#l(e,...t),this.#e.reallyExit=e=>this.#c(e)}}unload(){this.#a&&(this.#a=!1,this.#r.forEach(e=>{let t=this.#n[e];if(!t)throw new Error("Listener not defined for signal: "+e);try{this.#e.removeListener(e,t)}catch{}}),this.#e.emit=this.#s,this.#e.reallyExit=this.#i,this.#t.count-=1)}#c(e){return N(this.#e)?(this.#e.exitCode=e||0,this.#t.emit("exit",this.#e.exitCode,null),this.#i.call(this.#e,this.#e.exitCode)):0}#l(e,...t){let a=this.#s;if(e==="exit"&&N(this.#e)){typeof t[0]=="number"&&(this.#e.exitCode=t[0]);let s=a.call(this.#e,e,...t);return this.#t.emit("exit",this.#e.exitCode,null),s}else return a.call(this.#e,e,...t)}},V=null,Oe=(r,e)=>(V||(V=N(process)?new H(process):new B),V.onExit(r,e));function _e(r,{timeout:e}={}){let t=new Promise((c,u)=>{r.on("exit",(l,m)=>{c({exitCode:l,signal:m,timedOut:!1})}),r.on("error",l=>{u(l)}),r.stdin&&r.stdin.on("error",l=>{u(l)})}),a=Oe(()=>{r.kill()});if(e===0||e===void 0)return t.finally(()=>a());let s,i=new Promise((c,u)=>{s=setTimeout(()=>{r.kill("SIGTERM"),u(Object.assign(new Error("Timed out"),{timedOut:!0,signal:"SIGTERM"}))},e)}),n=t.finally(()=>{clearTimeout(s)});return Promise.race([i,n]).finally(()=>a())}var G=class extends Error{constructor(){super("The output is too big"),this.name="MaxBufferError"}};function Ne(r){let{encoding:e}=r,t=e==="buffer",a=new F.default.PassThrough({objectMode:!1});e&&e!=="buffer"&&a.setEncoding(e);let s=0,i=[];return a.on("data",n=>{i.push(n),s+=n.length}),a.getBufferedValue=()=>t?Buffer.concat(i,s):i.join(""),a.getBufferedLength=()=>s,a}async function te(r,e){let t=Ne(e);return await new Promise((a,s)=>{let i=n=>{n&&t.getBufferedLength()<=se.constants.MAX_LENGTH&&(n.bufferedData=t.getBufferedValue()),s(n)};(async()=>{try{await(0,ie.promisify)(F.default.pipeline)(r,t),a()}catch(n){i(n)}})(),t.on("data",()=>{t.getBufferedLength()>8e7&&i(new G)})}),t.getBufferedValue()}async function re(r,e){r.destroy();try{return await e}catch(t){return t.bufferedData}}async function Le({stdout:r,stderr:e},{encoding:t},a){let s=te(r,{encoding:t}),i=te(e,{encoding:t});try{return await Promise.all([a,s,i])}catch(n){return Promise.all([{error:n,exitCode:null,signal:n.signal,timedOut:n.timedOut||!1},re(r,s),re(e,i)])}}function We(r){let e=typeof r=="string"?`
`:10,t=typeof r=="string"?"\r":13;return r[r.length-1]===e&&(r=r.slice(0,-1)),r[r.length-1]===t&&(r=r.slice(0,-1)),r}function ae(r,e){return r.stripFinalNewline?We(e):e}function Me({timedOut:r,timeout:e,signal:t,exitCode:a}){return r?`timed out after ${e} milliseconds`:t!=null?`was killed with ${t}`:a!=null?`failed with exit code ${a}`:"failed"}function je({stdout:r,stderr:e,error:t,signal:a,exitCode:s,command:i,timedOut:n,options:c,parentError:u}){let m=`Command ${Me({timedOut:n,timeout:c?.timeout,signal:a,exitCode:s})}: ${i}`,f=t?`${m}
${t.message}`:m,E=[f,e,r].filter(Boolean).join(`
`);return t?t.originalMessage=t.message:t=u,t.message=E,t.shortMessage=f,t.command=i,t.exitCode=s,t.signal=a,t.stdout=r,t.stderr=e,"bufferedData"in t&&delete t.bufferedData,t}function Ve({stdout:r,stderr:e,error:t,exitCode:a,signal:s,timedOut:i,command:n,options:c,parentError:u}){if(t||a!==0||s!==null)throw je({error:t,exitCode:a,signal:s,stdout:r,stderr:e,command:n,timedOut:i,options:c,parentError:u});return r}async function $(r,e,t){if(process.platform!=="darwin")throw new Error("AppleScript is only supported on macOS");let{humanReadableOutput:a,language:s,timeout:i,...n}=Array.isArray(e)?t||{}:e||{},c=a!==!1?[]:["-ss"];s==="JavaScript"&&c.push("-l","JavaScript"),Array.isArray(e)&&c.push("-",...e);let u=ne.default.spawn("osascript",c,{...n,env:{PATH:"/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"}}),l=_e(u,{timeout:i??1e4});u.stdin.end(r);let[{error:m,exitCode:f,signal:E,timedOut:W},S,R]=await Le(u,{encoding:"utf8"},l),Ie=ae({stripFinalNewline:!0},S),Ae=ae({stripFinalNewline:!0},R);return Ve({stdout:Ie,stderr:Ae,error:m,exitCode:f,signal:E,timedOut:W,command:"osascript",options:t,parentError:new Error})}var C=require("child_process"),g=require("@raycast/api");var ce=require("fs");async function ze(){let r="";try{r=(0,C.execSync)(`/bin/zsh -lc 'realpath "$(which brew)"'`).toString().trim()}catch(e){console.error(e)}if(r==="")return await(0,g.showToast)({title:"Homebrew is required to install the AVIF encoder.",message:"Please install Homebrew and try again. Visit https://brew.sh for more information. Once Homebrew is installed, run the command `brew install libavif` to install the AVIF encoder manually (Otherwise, this command will be run automatically).",style:g.Toast.Style.Failure}),!1;if(await(0,g.confirmAlert)({title:"Install AVIF Encoder",message:"The libavif Homebrew formula is required to convert images to/from AVIF format. Would you like to install it now?",primaryAction:{title:"Install"}})){let e=await(0,g.showToast)({title:"Installing AVIF Encoder...",style:g.Toast.Style.Animated});try{if((0,C.execSync)(`/bin/zsh -ilc '${r} install --quiet libavif || true'`),!Be())throw new Error("The avifenc binary has not been added to the user's $PATH");return e.title="AVIF Encoder installed successfully!",e.style=g.Toast.Style.Success,!0}catch(t){console.error(t),b("Failed to install AVIF Encoder.",t,e,"If you previously attempted to install libavif or avifenc, please run `brew doctor` followed by `brew cleanup` and try again.")}}return await(0,g.showToast)({title:"AVIF Encoder not installed.",style:g.Toast.Style.Failure}),!1}async function Be(){let t=!1,a=0;for(;!t&&a<7;){let s=(0,C.execSync)("/bin/zsh -lc 'command -v avifenc'").toString().trim();if((0,ce.existsSync)(s)){t=!0;break}await new Promise(i=>setTimeout(i,1e3)),a++}return t}async function K(){let r=await g.LocalStorage.getItem("avifEncoderPath"),e=await g.LocalStorage.getItem("avifDecoderPath");if(!r||!e)try{r=(0,C.execSync)(`/bin/zsh -lc 'realpath "$(which avifenc)"'`).toString().trim(),e=(0,C.execSync)(`/bin/zsh -lc 'realpath "$(which avifdec)"'`).toString().trim()}catch(t){if(await ze())try{return await K()}catch(a){console.error(a),b("AVIF Encoder not found.",a,void 0,"Please install the libavif Homebrew formula manually and try again.")}else b("AVIF Encoder not found.",t,void 0,"Please install the libavif Homebrew formula and try again.")}return{encoderPath:r,decoderPath:e}}var le=async()=>$(`use framework "AppKit"
...
`),process.nextTick(()=>l.stdin.uncork()),e?.logSentMessages&&console.log(`Sent message: ${f}`))},{data:(async()=>new Promise((f,E)=>{let W=e?.timeout?setTimeout(()=>{try{l.kill()}catch(S){e?.logErrors&&console.error(`Error killing process: ${S}`)}return e?.logErrors&&console.error("Script timed out"),l.stdin.end(),l.kill(),E("Script timed out")},e?.timeout):void 0;l.on("close",S=>{if(S!==0)return e?.logErrors&&console.error(`Script exited with code ${S}`),l.stdin.end(),l.kill(),E(`Script exited with code ${S}`);clearTimeout(W);let R;try{R=JSON.parse(c)}catch{R=c.trim()}return e?.logFinalOutput&&console.log(`Script output: ${R}`),f(R)})}))(),sendMessage:u}}var A=require("@raycast/api");async function fe(){let r=I.default.join(A.environment.assetsPath,"scripts","finder.scpt"),e=await P(r,{language:"AppleScript",stderrCallback:t=>b("Finder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function de(){let r=I.default.join(A.environment.assetsPath,"scripts","houdahSpot.scpt"),e=await P(r,{language:"AppleScript",stderrCallback:t=>b("HoudahSpot Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function pe(){let r=I.default.join(A.environment.assetsPath,"scripts","neofinder.scpt"),e=await P(r,{language:"AppleScript",stderrCallback:t=>b("NeoFinder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function he(){let r=I.default.join(A.environment.assetsPath,"scripts","pathfinder.scpt"),e=await P(r,{language:"JXA",stderrCallback:t=>b("Path Finder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function me(){let r=I.default.join(A.environment.assetsPath,"scripts","qspace.scpt"),e=await P(r,{language:"JXA",stderrCallback:t=>b("QSpace Pro Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}async function ge(){let r=I.default.join(A.environment.assetsPath,"scripts","forklift-beta.scpt"),e=await P(r,{language:"JXA",stderrCallback:t=>b("ForkLift Selection Error",new Error(t))}).data;return Array.isArray(e)?e:e.split(",").map(t=>t.trim())}var J=async(r,e)=>{let t=d.default.join(y.tmpdir(),`${r}.${e}`);return{path:t,[Symbol.asyncDispose]:async()=>{p.existsSync(t)&&await p.promises.rm(t,{recursive:!0})}}};var ye=async()=>{let e=(await o.LocalStorage.getItem("itemsToRemove")??"").toString().split(", ");for(let t of e)p.existsSync(t)&&await p.promises.rm(t,{recursive:!0});await o.LocalStorage.removeItem("itemsToRemove")},$e=async()=>{let r=[],t=(0,o.getPreferenceValues)().inputMethod,a=!1;if(t=="Clipboard")try{let n=(await le()).split(", ");if(await o.LocalStorage.setItem("itemsToRemove",n.join(", ")),n.filter(c=>c.trim().length>0).length>0)return n}catch(n){console.error(`Couldn't get images from clipboard: ${n}`),a=!0}let s=t;try{s=(await(0,o.getFrontmostApplication)()).name}catch(n){console.error(`Couldn't get frontmost application: ${n}`)}try{(t=="Path Finder"||s=="Path Finder")&&(r=await he())}catch(n){console.error(`Couldn't get images from Path Finder: ${n}`),a=!0}try{(t=="NeoFinder"||s=="NeoFinder")&&(r=await pe())}catch(n){console.error(`Couldn't get images from NeoFinder: ${n}`),a=!0}try{(t=="HoudahSpot"||s=="HoudahSpot")&&(r=await de())}catch(n){console.error(`Couldn't get images from HoudahSpot: ${n}`),a=!0}try{(t=="QSpace Pro"||s=="QSpace Pro")&&(r=await me())}catch(n){console.error(`Couldn't get images from QSpace Pro: ${n}`),a=!0}try{(t=="ForkLift"||s=="ForkLift")&&(r=await ge())}catch(n){console.error(`Couldn't get images from ForkLift: ${n}`),a=!0}if(r.length>0)return r.filter((n,c)=>r.indexOf(n)===c);let i=await fe();return s=="Finder"||t=="Finder"||a?r=i:i.forEach(n=>{n.split("/").at(-2)=="Desktop"&&!r.includes(n)&&r.push(n)}),r.filter((n,c)=>r.indexOf(n)===c)},we=async r=>{let e="Finder";try{e=(await(0,o.getFrontmostApplication)()).name}catch(a){console.error(`Couldn't get frontmost application: : ${a}`)}let t=(0,o.getPreferenceValues)();t.imageResultHandling=="copyToClipboard"?(await ue(r),be(r)):t.imageResultHandling=="openInPreview"?(await Ke(r),be(r)):t.inputMethod=="NeoFinder"||e=="NeoFinder"?await(0,o.showInFinder)(r[0]):(t.inputMethod=="HoudahSpot"||e=="HoudahSpot")&&await(0,o.showInFinder)(r[0])},He=async()=>(y.cpus()[0].model.includes("Apple")?"arm":"x86")=="arm"?((0,w.execSync)(`chmod +x ${o.environment.assetsPath}/webp/arm/dwebp`),(0,w.execSync)(`chmod +x ${o.environment.assetsPath}/webp/arm/cwebp`),p.existsSync(`${o.environment.assetsPath}/webp/x86/dwebp`)&&await p.promises.rm(`${o.environment.assetsPath}/webp/x86/dwebp`),p.existsSync(`${o.environment.assetsPath}/webp/x86/cwebp`)&&await p.promises.rm(`${o.environment.assetsPath}/webp/x86/cwebp`),[`${o.environment.assetsPath}/webp/arm/dwebp`,`${o.environment.assetsPath}/webp/arm/cwebp`]):((0,w.execSync)(`chmod +x ${o.environment.assetsPath}/webp/x86/dwebp`),(0,w.execSync)(`chmod +x ${o.environment.assetsPath}/webp/x86/cwebp`),p.existsSync(`${o.environment.assetsPath}/webp/arm/dwebp`)&&await p.promises.rm(`${o.environment.assetsPath}/webp/arm/dwebp`),p.existsSync(`${o.environment.assetsPath}/webp/arm/cwebp`)&&await p.promises.rm(`${o.environment.assetsPath}/webp/arm/cwebp`),[`${o.environment.assetsPath}/webp/x86/dwebp`,`${o.environment.assetsPath}/webp/x86/cwebp`]),ke=async(r,e)=>{var c=[];try{let t=(0,o.getPreferenceValues)();let a=O(c,await J("tmp","png"),!0);let s=(await D([e]))[0];let[i,n]=await He();(0,w.execSync)(`${i} "${e}" -o "${a.path}" && ${r} "${a.path}" && ${n} ${t.useLosslessConversion?"-lossless":""} "${a.path}" -o "${s}"`);return s}catch(u){var l=u,m=!0}finally{var f=_(c,l,m);f&&await f}},Se=async(r,e)=>{var c=[];try{let t=(0,o.getPreferenceValues)();let a=O(c,await J("tmp","png"),!0);let s=(await D([e]))[0];let{encoderPath:i,decoderPath:n}=await K();(0,w.execSync)(`${n} "${e}" "${a.path}" && ${r} "${a.path}" && ${i} ${t.useLosslessConversion?"-s 0 --min 0 --max 0 --minalpha 0 --maxalpha 0 --qcolor 100 --qalpha 100":""}  "${a.path}" "${s}"`);return s}catch(u){var l=u,m=!0}finally{var f=_(c,l,m);f&&await f}},xe=async(r,e)=>{var s=[];try{let t=O(s,await J("tmp","bmp"),!0);let a=(await D([e]))[0];await Ge("BMP",e,t.path);(0,w.execSync)(`chmod +x ${o.environment.assetsPath}/potrace/potrace`);(0,w.execSync)(`${r} "${t.path}" && ${o.environment.assetsPath}/potrace/potrace -s --tight -o "${a}" "${t.path}"`);return a}catch(i){var n=i,c=!0}finally{var u=_(s,n,c);u&&await u}},Ge=async(r,e,t)=>$(`use framework "Foundation"
  ...
  end tell`)},D=async(r,e=!1,t=void 0)=>{let a=(0,o.getPreferenceValues)(),s=await Xe(r[0]);return r.map(i=>{let n=i;if(a.imageResultHandling=="saveToDownloads"?n=d.default.join(y.homedir(),"Downloads",d.default.basename(n)):a.imageResultHandling=="saveToDesktop"?n=d.default.join(y.homedir(),"Desktop",d.default.basename(n)):(a.imageResultHandling=="saveInContainingFolder"||a.imageResultHandling=="replaceOriginal")&&(a.inputMethod=="Clipboard"||e)?n=d.default.join(s,d.default.basename(n)):(a.imageResultHandling=="copyToClipboard"||a.imageResultHandling=="openInPreview")&&(n=d.default.join(y.tmpdir(),d.default.basename(n))),n=t?n.replace(d.default.extname(n),`.${t}`):n,a.imageResultHandling!="replaceOriginal"&&y.tmpdir()!=d.default.dirname(n)){let c=2;for(;p.existsSync(n);)n=d.default.join(d.default.dirname(n),d.default.basename(n,d.default.extname(n))+`-${c}${d.default.extname(n)}`),c++}return n})},b=async(r,e,t,a)=>{console.error(e),t?(t.title=r,t.message=a??e.message,t.style=o.Toast.Style.Failure,t.primaryAction={title:"Copy Error",onAction:async()=>{await o.Clipboard.copy(e.message)}}):t=await(0,o.showToast)({title:r,message:a??e.message,style:o.Toast.Style.Failure,primaryAction:{title:"Copy Error",onAction:async()=>{await o.Clipboard.copy(e.message)}}})};var ve=r=>{let e=y.homedir();if(r.startsWith("~"))return r.replace(/^~(?=$|\/|\\)/,e);let t=/(\/Users\/.*?)\/.*/,a=r.match(t);return a?r.replace(a[1],e):r};async function Z(r,e,t){let a=r.map(n=>ve(n)),s=await D(a),i=[];for(let n of a){let c=(0,X.execSync)(`sips -g pixelWidth -g pixelHeight "${n}"`).toString().split(/(: |\n)/g),u=parseInt(c[4]),l=parseInt(c[8]);if(n.toLowerCase().endsWith(".webp"))i.push(await ke(`sips --padToHeightWidth ${l+e} ${u+e} --padColor ${t}`,n));else if(n.toLowerCase().endsWith(".svg"))i.push(await xe(`sips --padToHeightWidth ${l+e} ${u+e} --padColor ${t}`,n));else if(n.toLowerCase().endsWith(".avif"))i.push(await Se(`sips --padToHeightWidth ${l+e} ${u+e} --padColor ${t}`,n));else{let m=s[a.indexOf(n)];i.push(m),(0,X.execSync)(`sips --padToHeightWidth ${l+e} ${u+e} --padColor ${t} -o "${m}" "${n}"`)}}return await we(i),i}var T=require("@raycast/api");async function q(r){if(r.selectedImages.length===0||r.selectedImages.length===1&&r.selectedImages[0]===""){await(0,T.showToast)({title:"No images selected",message:"No images found in your selection. Make sure the image(s) still exist on the disk. If using a third-party file manager, make sure the app's index is up to date.",style:T.Toast.Style.Failure});return}let e=await(0,T.showToast)({title:r.inProgressMessage,style:T.Toast.Style.Animated}),t=`image${r.selectedImages.length===1?"":"s"}`;try{let a=await r.operation();return e.title=`${r.successMessage} ${r.selectedImages.length.toString()} ${t}`,e.style=T.Toast.Style.Success,a}catch(a){await b(`${r.failureMessage} ${r.selectedImages.length.toString()} ${t}`,a,e)}finally{await ye()}}async function Pe(r){let{amount:e,hexcolor:t}=r.arguments,a=await $e(),s=(0,k.getPreferenceValues)(),i=parseInt(e);if(isNaN(i)||i<0){await(0,k.showToast)({title:"Padding amount must be a positive integer",style:k.Toast.Style.Failure});return}let n=t||s.defaultPadColor;if(n.startsWith("#")&&(n=n.substring(1)),!n.match(/[0-9A-Fa-f]{6}/)){await(0,k.showToast)({title:"Invalid HEX Color",style:k.Toast.Style.Failure});return}await q({operation:()=>Z(a,i,n),selectedImages:a,inProgressMessage:"Padding in progress...",successMessage:"Padded",failureMessage:"Failed to pad"})}
