        ...
        if popup.visible then
            ...
            elseif placement == "top_right" then
                awful.placement.top_right(
                    popup,
                    { margins = { top = 45, right = 12 }, parent = awful.screen.focused() }
                )
            elseif placement == "top_left" then
                awful.placement.top_left(popup, { margins = { top = 45, left = 12 }, parent = awful.screen.focused() })
            elseif placement == "bottom_right" then
                awful.placement.bottom_right(
                    popup,
                    { margins = { bottom = 45, right = 12 }, parent = awful.screen.focused() }
                )
            elseif placement == "bottom_left" then
                awful.placement.bottom_left(
                    popup,
                    { margins = { bottom = 45, left = 12 }, parent = awful.screen.focused() }
                )
            else
                awful.placement.top(popup, { margins = { top = 45 }, parent = awful.screen.focused() })
            end
