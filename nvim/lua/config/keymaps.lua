...
vim.keymap.set("x", "<leader>p", [["_dP]], { desc = "Paste without change register", remap = true })
vim.keymap.set({ "n", "v" }, "<leader>d", [["_d]], { desc = "Delete without change register", remap = true })
